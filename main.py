...
class MainApp(MainV2211App):
    def __init__(self, master=None):
        ...
        button_run_ftm = self.builder.get_object("button_run_ftm", master)
        button_run_ftm_fcc = self.builder.get_object("button_run_ftm_fcc", master)
        button_run_ftm_ce = self.builder.get_object("button_run_ftm_ce", master)
        button_run_ftm_endc = self.builder.get_object("button_run_ftm_endc", master)
        button_run_signaling = self.builder.get_object("button_run_signaling", master)
        button_run_cse = self.builder.get_object("button_run_cse", master)
        button_run_ulca = self.builder.get_object("button_run_ulca", master)
        button_run_apt = self.builder.get_object("button_run_apt", master)
        self.button_mpr_gen = self.builder.get_object("button_mpr_gen", master)
    ...
    def merge_nv(self):
        ...
        regy_replace(self.base_regy.get(), self.changed_regy.get(), OUTPUT_PATH)
    ...
    def separate_nv_2(self):
        OUTPUT_PATH = pathlib.Path('regy_separate')
        regy_extract_2(self.base_regy_sep.get(), self.separate_txt.get(), OUTPUT_PATH)
        logger.info('Separate Successfully')
